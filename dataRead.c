 ...
 *     else:
 */
  __pyx_t_6 = (((__pyx_v_bitCount + __pyx_v_bitOffset) > 24) != 0);
  if (__pyx_t_6) {
 ...
 *     cdef char temp7[7]
 */
  __pyx_v_nBytes = (__pyx_v_bitCount + __Pyx_div_long(__pyx_v_bitOffset, 8));
 ...
 *     if bitCount == 64:
 */
  __pyx_t_6 = (((__pyx_v_bitCount + __Pyx_mod_long(__pyx_v_bitOffset, 8)) > 0) != 0);
  if (__pyx_t_6) {
